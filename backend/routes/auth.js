...
router.post("/register", loginRegisterLimiter, validateRegister, handleValidationErrors, register);
// Log in with email and password.
router.post("/login", loginRegisterLimiter, validateLogin, handleValidationErrors, login);
